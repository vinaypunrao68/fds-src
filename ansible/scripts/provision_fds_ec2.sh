...
ansible_args="${playbooks}/provision_fds_ec2.yml -i ${ansible_base_dir}/inventory/${inventory} -e "instance_name_tag=${inventory}" -e "deploy_artifact=${deploy_source}" -e "fds_cluster_name=${inventory}""
