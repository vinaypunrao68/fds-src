angular.module( 'form-directives' ).directive( 'slider', function(){
    ...
    return {
        ...
        controller: function( $scope, $document, $element, $timeout ){
            ...
            var page_shown = $scope.$on( 'fds::page_shown', asyncSetValue );
            var fui_slider_refresh = $scope.$on( 'fds::fui-slider-refresh', asyncSetValue );
            
            var dest = $scope.$on( 'destroy', function(){
                page_shown();
                fui_slider_refresh();
                dest();
            });
