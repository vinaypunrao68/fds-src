angular.module( 'qos' ).directive( 'qosPanel', function(){
    ...
    return {
        ...
        controller: function( $scope, $filter, $volume_api ){
            ...
            $scope.custom = { priority: 5, iopsMin: $volume_api.MIN_GUARANTEE_VALUE, iopsMax: 0, name: $filter( 'translate' )( 'common.l_custom' ) };
            
            $scope.qos = {};
            $scope.editing = false;           
            
            $scope.limitChoices = [100,200,300,500,1000,2000,3000,5000,7500, 10000,0];
            $scope.guaranteeChoices = [$volume_api.MIN_GUARANTEE_VALUE,100,200,300,500,1000,2000,3000,5000, 7500, 10000];
            ...
            $scope.guaranteeSliderLabel = function( value ){
                ...
                if ( value <= $volume_api.MIN_GUARANTEE_VALUE ){
