...
{
    Error err(ERR_OK);
    dmCatReq  *qryCatReq = (fds::DataMgr::dmCatReq*)_io;
    ObjectID obj_id;
...
void DMSvcHandler::queryCatalogObject(boost::shared_ptr<QueryCatalogMsg>& queryMsg)
{
    /*
     * allocate a new query cat log  class and  queue  to per volume queue.
     */
...
void DMSvcHandler::queryCatalogObjectCb(boost::shared_ptr<QueryCatalogMsg>& queryMsg,
