...
public class RecurrenceRuleTest {
    ...
    public void nates() {
        ...
        final SnapshotPolicy create = gson.fromJson( create_json, SnapshotPolicy.class );
        System.out.println( create );

        final SnapshotPolicy edit = gson.fromJson( edit_json, SnapshotPolicy.class );
        System.out.println( edit );
        
        final SnapshotPolicy lastTuesday = gson.fromJson( lastTuesdayJson, SnapshotPolicy.class );
        
        WeekDays days = lastTuesday.getRecurrenceRule().getDays();
    ...
    public void json() {
        ...
        Gson gson = GSONTest.gson();
        final String json = gson.toJson( policy, SnapshotPolicy.class );
        System.out.println( json );
        System.out.println( gson.fromJson( json, SnapshotPolicy.class ).toString() );
    }
}