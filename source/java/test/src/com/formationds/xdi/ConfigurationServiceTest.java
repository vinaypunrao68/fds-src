...
public class ConfigurationServiceTest {
    ...
    public void testIntegration() throws Exception {
        ConfigurationService.Iface config = new XdiClientFactory(7053).remoteOmService("localhost", 9090);
    ...
    public void testLegacyClient() throws Exception {
        FDSP_ConfigPathReq.Iface client = new XdiClientFactory(7053).legacyConfig("localhost", 8903);
