    ...
    extends NfsOptionBase<Boolean>
{
    ...
    public RootSquash( final Boolean bool )
    {
        super( );
        this.squash = bool;
    }
    ...
    public boolean equals( final Object o )
    {
        ...
        if ( !( o instanceof RootSquash ) ) return false;
        final RootSquash that = ( RootSquash ) o;
        return Objects.equals( squash, that.squash );
    }
