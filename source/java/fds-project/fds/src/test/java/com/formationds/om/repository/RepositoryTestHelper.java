...
abstract public class RepositoryTestHelper {
    ...
    public static EnumMap<Metrics, MetricInfo<? extends Number>> metricsSuppliers =
            ...
            /**
             *
             * @param mockedMetricRepo
             */
            public static void setMockedMetricRepository( MetricRepository mockedMetricRepo ) {
                SingletonRepositoryManager.instance().metricRepo( mockedMetricRepo );
            }

            /**
             *
             * @param mockedEventRepo
             */
            public static void setMockedEventRepository( EventRepository mockedEventRepo ) {
                SingletonRepositoryManager.instance().eventRepo( mockedEventRepo );
            }
            ...
            public static void main(String[] args)
            {
                ...
                List<IVolumeDatapoint> results = store.query( new QueryCriteria( QueryType.UNIT_TEST ) );
