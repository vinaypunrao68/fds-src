...
public class PersistentCounterTest {
    ...
    public void testAllocate() throws Exception {
        ...
        PersistentCounter allocator = new PersistentCounter(transactions, counterName, startValue, false);
        ...
        // test restart
        allocator = new PersistentCounter(transactions, counterName, startValue, false);
