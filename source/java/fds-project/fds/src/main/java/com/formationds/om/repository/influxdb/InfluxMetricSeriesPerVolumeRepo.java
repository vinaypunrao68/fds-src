...
public class InfluxMetricSeriesPerVolumeRepo extends InfluxMetricRepository {
     ...
     */
    public static final String SERIES_NAME_FMT = "domain.%s_volname.%s_volid.%d_metrics";

    public static final String SERIES_QUERY_FMT                   = "domain.%s_volname.%s_volid.%d_metrics";
    public static final String SERIES_QUERY_BY_VOLNAME_DOMAIN_FMT = "/domain.%s_volname.%s_volid.\\.*_metrics/";
    public static final String SERIES_QUERY_BY_VOLNAME_FMT        = "/domain.\\.*_volname.%s_volid.\\.*_metrics/";
    public static final String SERIES_QUERY_BY_VOLID_FMT          = "/domain.\\.*_volname.\\.*_volid.%d_metrics/";
    public static final String SERIES_QUERY_ALL_FOR_VOLDOMAIN_FMT = "/domain.%s_volname.\\.*_volid.\\.*_metrics/";
    public static final String SERIES_QUERY_ALL_VOL_FMT           = "/domain.\\.*_volname.\\.*_volid.\\.*_metrics/";
    ...
    private static final String VOLID_TOKEN = "_volid.";
    private static final String VOLNAME_TOKEN = "_volname.";
    private static final String METRICS_TOKEN = "_metrics";
     ...
     */
    // "domain.%s_volname.%s_volid.%d_metrics"
