...
public class CustomNfsV3Server extends nfs3_protServerStub {
    ...
    public FSINFO3res NFSPROC3_FSINFO_3(RpcCall call$, FSINFO3args arg1) {
        ...
        try {
            ...
            res.resok.rtmax = new uint32(1024 * 1024);
            // preferred size of READ request
            res.resok.rtpref = new uint32(1024 * 1024);
            ...
            res.resok.wtmax = new uint32(1024 * 1024);
            // preferred size of WRITE request
            res.resok.wtpref = new uint32(1024 * 1024);
