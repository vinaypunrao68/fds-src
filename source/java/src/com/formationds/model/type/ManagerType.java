...
package com.formationds.model.type;

import com.formationds.model.i18n.ModelResource;
...
public enum ManagerType
{
  ...
  /**
   * @param displayable the displayable name
   */
  ManagerType( final String displayable )
  {
   ...
   */
  public static ManagerType byName( final String name )
  {
