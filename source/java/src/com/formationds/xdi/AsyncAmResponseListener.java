 ...
 */
public class AsyncAmResponseListener
  implements AsyncAmServiceResponse.Iface {
  ...
  @Override
  public void statBlobResponse( RequestId requestId, BlobDescriptor blobDescriptor )
    throws TException {
  ...
  @Override
  public void commitBlobTxResponse( RequestId requestId )
    throws TException {
    complete( requestId, null );
  }

  @Override
  public void abortBlobTxResponse( RequestId requestId )
    throws TException {
    complete( requestId, null );
  }

  @Override
  public void getBlobResponse( RequestId requestId, ByteBuffer byteBuffer )
    throws TException {
    complete( requestId, byteBuffer );
  }

  @Override
  public void updateMetadataResponse( RequestId requestId )
    throws TException {
    complete( requestId, null );
  }

  @Override
  public void updateBlobResponse( RequestId requestId )
    throws TException {
    complete( requestId, null );
  }

  @Override
  public void updateBlobOnceResponse( RequestId requestId )
    throws TException {
    complete( requestId, null );
  }

  @Override
  public void deleteBlobResponse( RequestId requestId )
    throws TException {
    complete( requestId, null );
  }

  @Override
  public void volumeStatus( RequestId requestId, VolumeStatus volumeStatus )
    throws TException {
    complete( requestId, volumeStatus );
  }

  @Override
  public void completeExceptionally( RequestId requestId, ErrorCode errorCode, String s )
    throws TException {
    CompletableFuture cf = pending.getIfPresent( requestId );
    if( cf == null ) {
      LOG.error( "RequestId " + requestId.getId() + " had no pending requests" );
