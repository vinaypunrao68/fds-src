 ...
 * @author ptinius
 */
public class AttachSnapshotPolicyIdToVolumeId
  implements RequestHandler
{
  private static final Logger LOG = Logger.getLogger(AttachSnapshotPolicyIdToVolumeId.class);

  private final Xdi xdi;
  private final FDSP_ConfigPathReq.Iface legacyConfigPath;
  private final AuthenticationToken token;

  public AttachSnapshotPolicyIdToVolumeId( final Xdi xdi,
