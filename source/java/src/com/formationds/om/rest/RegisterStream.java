...
public class RegisterStream implements RequestHandler {
    ...
    public Resource handle(Request request, Map<String, String> routeParameters) throws Exception {
        ...
        String httpMethod = o.getString("http_method");
        List<String> volumeNames = asList(o.getJSONArray("volume_names"));

        int sampleFreqSeconds = o.getInt("sample_freq_seconds");
        int durationSeconds = o.getInt("duration_seconds");
