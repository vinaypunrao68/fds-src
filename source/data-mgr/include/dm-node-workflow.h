...
class DmWorkItem : public NodeWorkItem
{
  public:
    typedef bo::intrusive_ptr<DmWorkItem> ptr;
    typedef bo::intrusive_ptr<const DmWorkItem> const_ptr;

    DmWorkItem(fpi::SvcUuid &peer, fpi::DomainID &did,
...
class DmWorkFlow;
extern DmWorkFlow          gl_DmWorkFlow;

class DmWorkFlow : public NodeWorkFlow
{
  public:
    /* Singleton access. */
    static DmWorkFlow *nd_workflow_sgt() { return &gl_DmWorkFlow; }
...
#endif  // SOURCE_DATA_MGR_INCLUDE_DM_NODE_WORKFLOW_H_
