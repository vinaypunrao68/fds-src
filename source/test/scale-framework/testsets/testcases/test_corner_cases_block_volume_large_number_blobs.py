...
class TestBlockVolumeLargeNumberBlobsForCornerCases(testcase.FDSTestCase):
    ...
    MAX_NUMBER_BLOBS = 5 
    NUMBER_OF_ITERATION = 1  #number of times to run the test:w
	...
	bv = block_volumes.BlockVolumes(self.om_ip_address)
    ...
    def delete_block_volume2(self, volume_name):
        test_passed = True
        r = None
	...
	'''
		...
		if self.delete_block_volume2(volume_name) == True:
