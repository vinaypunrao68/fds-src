...
if __name__ == "__main__":
	...
	main(options,files)
	time_end = time.time()
	print "threads:", options.threads, "n_reqs:", options.n_reqs, "req_type:", options.req_type, "elapsed time:", (time_end - time_start), "reqs/sec:", options.threads * options.n_reqs / (time_end - time_start)
	print stats
