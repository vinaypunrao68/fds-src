Ice/LocalException.php: "$(slicedir)/Ice/LocalException.ice" "$(slicedir)/Ice/Identity.ice" "$(slicedir)/Ice/Version.ice" "$(slicedir)/Ice/BuiltinSequences.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
Ice/Communicator.php: "$(slicedir)/Ice/Communicator.ice" "$(slicedir)/Ice/LoggerF.ice" "$(slicedir)/Ice/StatsF.ice" "$(slicedir)/Ice/InstrumentationF.ice" "$(slicedir)/Ice/ObjectAdapterF.ice" "$(slicedir)/Ice/ObjectFactoryF.ice" "$(slicedir)/Ice/RouterF.ice" "$(slicedir)/Ice/LocatorF.ice" "$(slicedir)/Ice/PluginF.ice" "$(slicedir)/Ice/ImplicitContextF.ice" "$(slicedir)/Ice/Current.ice" "$(slicedir)/Ice/ConnectionF.ice" "$(slicedir)/Ice/Identity.ice" "$(slicedir)/Ice/Version.ice" "$(slicedir)/Ice/Properties.ice" "$(slicedir)/Ice/BuiltinSequences.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
...
Ice/Current.php: "$(slicedir)/Ice/Current.ice" "$(slicedir)/Ice/ObjectAdapterF.ice" "$(slicedir)/Ice/ConnectionF.ice" "$(slicedir)/Ice/Identity.ice" "$(slicedir)/Ice/Version.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
Ice/ImplicitContextF.php: "$(slicedir)/Ice/ImplicitContextF.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
Ice/ImplicitContext.php: "$(slicedir)/Ice/ImplicitContext.ice" "$(slicedir)/Ice/LocalException.ice" "$(slicedir)/Ice/Identity.ice" "$(slicedir)/Ice/Version.ice" "$(slicedir)/Ice/BuiltinSequences.ice" "$(slicedir)/Ice/Current.ice" "$(slicedir)/Ice/ObjectAdapterF.ice" "$(slicedir)/Ice/ConnectionF.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
...
Ice/Connection.php: "$(slicedir)/Ice/Connection.ice" "$(slicedir)/Ice/ObjectAdapterF.ice" "$(slicedir)/Ice/Identity.ice" "$(slicedir)/Ice/Endpoint.ice" "$(slicedir)/Ice/Version.ice" "$(slicedir)/Ice/BuiltinSequences.ice" "$(slicedir)/Ice/EndpointF.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
...
Ice/Endpoint.php: "$(slicedir)/Ice/Endpoint.ice" "$(slicedir)/Ice/Version.ice" "$(slicedir)/Ice/BuiltinSequences.ice" "$(slicedir)/Ice/EndpointF.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
...
Ice/Version.php: "$(slicedir)/Ice/Version.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
Ice/InstrumentationF.php: "$(slicedir)/Ice/InstrumentationF.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
Ice/Instrumentation.php: "$(slicedir)/Ice/Instrumentation.ice" "$(slicedir)/Ice/EndpointF.ice" "$(slicedir)/Ice/ConnectionF.ice" "$(slicedir)/Ice/Current.ice" "$(slicedir)/Ice/ObjectAdapterF.ice" "$(slicedir)/Ice/Identity.ice" "$(slicedir)/Ice/Version.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
Ice/Metrics.php: "$(slicedir)/Ice/Metrics.ice" "$(slicedir)/Ice/BuiltinSequences.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
Glacier2/RouterF.php: "$(slicedir)/Glacier2/RouterF.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
Glacier2/Router.php: "$(slicedir)/Glacier2/Router.ice" "$(slicedir)/Ice/Router.ice" "$(slicedir)/Ice/BuiltinSequences.ice" "$(slicedir)/Glacier2/Session.ice" "$(slicedir)/Ice/Identity.ice" "$(slicedir)/Glacier2/SSLInfo.ice" "$(slicedir)/Glacier2/PermissionsVerifier.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
...
Glacier2/Metrics.php: "$(slicedir)/Glacier2/Metrics.ice" "$(slicedir)/Ice/Metrics.ice" "$(slicedir)/Ice/BuiltinSequences.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
...
IceStorm/IceStorm.php: "$(slicedir)/IceStorm/IceStorm.ice" "$(slicedir)/Ice/SliceChecksumDict.ice" "$(slicedir)/IceStorm/Metrics.ice" "$(slicedir)/Ice/Metrics.ice" "$(slicedir)/Ice/BuiltinSequences.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
IceStorm/Metrics.php: "$(slicedir)/IceStorm/Metrics.ice" "$(slicedir)/Ice/Metrics.ice" "$(slicedir)/Ice/BuiltinSequences.ice" "$(SLICE2PHP)" "$(SLICEPARSERLIB)"
