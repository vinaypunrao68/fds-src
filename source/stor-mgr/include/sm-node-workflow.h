 ...
 */
#ifndef SOURCE_STOR_MGR_INCLUDE_SM_NODE_WORKFLOW_H_
#define SOURCE_STOR_MGR_INCLUDE_SM_NODE_WORKFLOW_H_

#include "platform/node_work_flow.h"

namespace fds {

class SmWorkItem : public NodeWorkItem
{
  public:
    typedef bo::intrusive_ptr<SmWorkItem> ptr;
    typedef bo::intrusive_ptr<const SmWorkItem> const_ptr;

    SmWorkItem(fpi::SvcUuid &peer, fpi::DomainID &did,
...
class SmWorkFlow;
extern SmWorkFlow          gl_SmWorkFlow;

class SmWorkFlow : public NodeWorkFlow
{
  public:
    /* Singleton access. */
    static SmWorkFlow *nd_workflow_sgt() { return &gl_SmWorkFlow; }
...
#endif  // SOURCE_STOR_MGR_INCLUDE_SM_NODE_WORKFLOW_H_
