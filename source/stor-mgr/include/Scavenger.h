 ...
 */
#ifndef SOURCE_STOR_MGR_INCLUDE_SCAVENGER_H_
#define SOURCE_STOR_MGR_INCLUDE_SCAVENGER_H_
...
class ScavControl {
    public:
     explicit ScavControl(fds_uint32_t const num_thrds);
     ~ScavControl();
...
#endif  // SOURCE_STOR_MGR_INCLUDE_SCAVENGER_H_
