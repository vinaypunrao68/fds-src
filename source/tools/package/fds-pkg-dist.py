...
class PkgDist:
    def __init__(self):
        ...
        self.testpkgformat= re.compile(".*T[0-9]+.deb")
        self.args = None
    ...
    def verify(self):
        ...
        for pkg in self.args.pkg:
            ...
            if self.testpkgformat.match(filename):
                log.error('[%s] is a test pkg. Please create a release pkg to upload with fds-pkg-create -r', filename)
                return False
...
if __name__ == "__main__":
    ...
    parser.add_argument('-b','--branch', default='test', help="upload to specific branch [test/stable]")
    parser.add_argument('-v','--verbose', action="store_true" , help = 'be more verbose')
    parser.add_argument('-n','--dryrun', action="store_true" , help = 'just check , dont upload')
