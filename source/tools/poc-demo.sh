...
# initial write (short)
./run-delay-workloads.sh -p "poc-demo-write" -w "sample_workloads/seq_write.sh:/dev/fbd0" -w "sample_workloads/seq_write.sh:/dev/fbd1" -w "sample_workloads/seq_write.sh:/dev/fbd2" -w "sample_workloads/seq_write.sh:/dev/fbd3"

sleep 15

# read sequentially data we wrote
./run-delay-workloads.sh -p "poc-demo-read" -w "sample_workloads/seq_read.sh:/dev/fbd0" -w "sample_workloads/seq_read.sh:/dev/fbd1" -w "sample_workloads/seq_read.sh:/dev/fbd2" -w "sample_workloads/seq_read.sh:/dev/fbd3"
