...
runtime=480        # number of IOs generator will produce ( positive number means length of experiment in seconds) 
blocksize=4          # in KB
outstand_count=60    # number of outstanding IOs from workload generator 
