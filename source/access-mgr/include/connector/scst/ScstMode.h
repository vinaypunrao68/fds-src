...
#ifndef SOURCE_ACCESS_MGR_INCLUDE_CONNECTOR_SCST_SCSTMODE_H_
#define SOURCE_ACCESS_MGR_INCLUDE_CONNECTOR_SCST_SCSTMODE_H_
...
#endif  // SOURCE_ACCESS_MGR_INCLUDE_CONNECTOR_SCST_SCSTMODE_H_
