...
#ifndef SOURCE_ACCESS_MGR_INCLUDE_CONNECTOR_SCST_SCSTADMIN_H_
#define SOURCE_ACCESS_MGR_INCLUDE_CONNECTOR_SCST_SCSTADMIN_H_
...
struct ScstAdmin
{
     ...
     * Remove the given credential to the target's IncomingUser attributes
     */
    static void setQueueDepth(std::string const& target_name, uint8_t const queue_depth);
};

}  // namespace fds

#endif  // SOURCE_ACCESS_MGR_INCLUDE_CONNECTOR_SCST_SCSTADMIN_H_
