...
/**
 * Different test volumes for DM to measure performance.
 */
class NbdDmVol : public NbdBlkVol
{
  public:
    NbdDmVol(const blk_vol_creat_t *r, struct ev_loop *loop) : NbdBlkVol(r, loop) {}
...
/**
 * NBD block module driving DM IO.
 */
class NbdDmMod : public NbdBlockMod
{
  public:
    NbdDmMod() : NbdBlockMod() {}
