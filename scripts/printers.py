...
class Tr1UnorderedMapPrinter:
    ...
    def to_string (self):
        return '%s with %d Elements: First element %x' % (self.typename, self.hashtable()['_M_element_count'], self.hashtable()['_M_bbegin']['_M_node']['_M_nxt'])
    ...
    @staticmethod
    def format_one (elt):
#        return (elt.address, elt['_M_nxt'], elt['_M_v']['first'], elt['_M_v']['second'])
        return (elt,)
...
register_type_printers(obj=None)
