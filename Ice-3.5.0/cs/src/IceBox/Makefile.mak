   ...
   <runtime>
      <assemblyBinding xmlns="urn:schemas-microsoft-com:asm.v1">
         <dependentAssembly>
            ...
            <codeBase version="3.5.0.0" href="$(assembliesRelativeDir)\Ice.dll"/>
         </dependentAssembly>
         <dependentAssembly>
            <assemblyIdentity name="IceBox"  culture="neutral" publicKeyToken="$(publicKeyToken)"/>
            <codeBase version="3.5.0.0" href="$(assembliesRelativeDir)\IceBox.dll"/>
         </dependentAssembly>
         <!-- 
	 ...
	 -->
         <dependentAssembly>
            ...
            <codeBase version="3.5.0.0" href="$(assembliesRelativeDir)\IceSSL.dll"/>
         </dependentAssembly>
      </assemblyBinding>
   </runtime>
</configuration>
