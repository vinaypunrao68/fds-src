...
BUILD_FOLDER="fds-dev-continuous"
...
export LD_LIBRARY_PATH=/usr/local/lib:/home/jenkins/build/fds-dev-continuous/leveldb-1.12.0:/home/jenkins/build/fds-dev-continuous/source/Build/linux-*/lib:/home/jenkins/build/fds-dev-continuous/libconfig-1.4.9/lib/.libs/
...
#for i in `seq 1 3`
#do
#    python fds-datagen.py -f cfg/datagen_io.cfg
#    if [ $? -gt 0 ]
#    then
#        ((fail_count += 1))
#    fi
