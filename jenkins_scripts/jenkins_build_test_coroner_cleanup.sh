...
SYSTEM_TEST_SCENARIO_LIST="BuildSmokeTest_onpr ActiveMigration RestartDataPersistence ActiveIOKillTest ActiveIORndKillTest MultiAMVolOpsTest ActiveIORestartTest RestartClusterKillServices"
DISABLED_SYSTEM_TEST_SCENARIO_LIST=""   ## This should be deleted when fs-2473 fs-2478 are resolved
