...
SYSTEM_TEST_SCENARIO_LIST="BuildSmokeTest_onpr ActiveMigration "
DISABLED_SYSTEM_TEST_SCENARIO_LIST="DmMigrationFailover StaticMigration ActiveIORestartTest RestartDataPersistence ActiveIOKillTest ActiveIORndKillTest MultiAMVolOpsTest QosTest RestartClusterKillServices"
