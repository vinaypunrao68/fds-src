...
SYSTEM_TEST_SCENARIO_LIST="BuildSmokeTest_onpr RestartDataPersistence ActiveIOKillTest ActiveIORndKillTest MultiAMVolOpsTest QosTest"
DISABLED_SYSTEM_TEST_SCENARIO_LIST="ActiveIORestartTest StaticMigration ActiveMigration"   ## This should be deleted when fs-2478 are resolved
